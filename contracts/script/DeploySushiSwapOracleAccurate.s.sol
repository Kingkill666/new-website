...
contract DeploySushiSwapOracleAccurate is Script {
    ...
    uint256 constant MAX_PRICE_USDC_PER_VMF = 0.2e18;   // 0.2 USDC per VMF (scaled to 1e18)
    
    function run() external {
        console.log("=== SushiSwap Oracle Accurate Deployment Script ===");
        ...
        // Deploy the accurate oracle
        console.log("\n=== Deploying Accurate SushiSwap Oracle ===");
        SushiSwapV3PriceOracleAccurate oracle = new SushiSwapV3PriceOracleAccurate(
            SUSHISWAP_POOL,
            VMF_ADDRESS,
            USDC_ADDRESS
        );
        ...
        console.log("2. Test the oracle with sqrtPriceX96 calculation");
    ...
    function validateOracleDeployment(address oracleAddress) internal view {
        SushiSwapV3PriceOracleAccurate oracle = SushiSwapV3PriceOracleAccurate(oracleAddress);
        ...
        // Validate accurate price calculation
        ...
        console.log("[OK] Price is within valid range (0.001 - 0.2 USDC per VMF)");
