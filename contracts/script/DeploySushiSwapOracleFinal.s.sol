...
contract DeploySushiSwapOracleFinal is Script {
    ...
    function run() external {
        console.log("=== SushiSwap Oracle Final Deployment Script ===");
        ...
        // Deploy the final oracle
        console.log("\n=== Deploying Final SushiSwap Oracle ===");
        SushiSwapV3PriceOracleFinal oracle = new SushiSwapV3PriceOracleFinal(
            SUSHISWAP_POOL,
            VMF_ADDRESS,
            USDC_ADDRESS
        );
    ...
    function validateOracleDeployment(address oracleAddress) internal view {
        SushiSwapV3PriceOracleFinal oracle = SushiSwapV3PriceOracleFinal(oracleAddress);
