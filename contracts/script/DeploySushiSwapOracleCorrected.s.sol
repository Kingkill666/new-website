...
import "../src/SushiSwapV3PriceOracleCorrected.sol";

/// @title DeploySushiSwapOracleCorrected
/// @notice Deployment script for the corrected SushiSwap V3 Price Oracle
contract DeploySushiSwapOracleCorrected is Script {
    ...
    function run() external {
        console.log("=== SushiSwap Oracle Corrected Deployment Script ===");
        ...
        // Deploy the corrected oracle
        console.log("\n=== Deploying Corrected SushiSwap Oracle ===");
        SushiSwapV3PriceOracleCorrected oracle = new SushiSwapV3PriceOracleCorrected(
            SUSHISWAP_POOL,
            VMF_ADDRESS,
            USDC_ADDRESS
        );
        ...
        console.log("2. Test the oracle with real pool reserves");
    ...
    function validateOracleDeployment(address oracleAddress) internal view {
        SushiSwapV3PriceOracleCorrected oracle = SushiSwapV3PriceOracleCorrected(oracleAddress);
        ...
        (address token0, address token1, uint24 fee, uint160 sqrtPriceX96, int24 tick, bool unlocked, uint256 vmfBalance, uint256 usdcBalance) = oracle.getPoolInfo();
        ...
        console.log("VMF Balance:", vmfBalance);
        ...
        // Validate corrected price calculation
        ...
        require(vmfBalance > 0, "VMF balance should be positive");
        require(usdcBalance > 0, "USDC balance should be positive");
        ...
        (uint160 currentSqrtPriceX96, int24 currentTick, uint256 currentPriceE18, bool currentIsValid, uint256 currentVmfBalance, uint256 currentUsdcBalance) = oracle.getCurrentPriceInfo();
        ...
        console.log("  VMF Balance:", currentVmfBalance);
        ...
        // Test detailed pool info
        (address dt0, address dt1, uint24 dfee, uint160 dsqrtPriceX96, int24 dtick, bool dunlocked, uint256 dvmfBalance, uint256 dusdcBalance, uint256 dpriceE18, string memory dpriceDescription) = oracle.getDetailedPoolInfo();
        console.log("Detailed Pool Info:");
        console.log("  Token0:", dt0);
        console.log("  Token1:", dt1);
        console.log("  Fee:", dfee);
        console.log("  SqrtPriceX96:", dsqrtPriceX96);
        console.log("  Tick:", dtick);
        console.log("  Unlocked:", dunlocked);
        console.log("  VMF Balance:", dvmfBalance);
        console.log("  USDC Balance:", dusdcBalance);
        console.log("  Price:", dpriceE18);
        console.log("  Description:", dpriceDescription);
        
        console.log("[OK] Detailed pool info validated");
    }
}
